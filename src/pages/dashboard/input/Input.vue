<template>
  <v-container class="fill-height" fluid>
    <v-row>
      ...
      <v-col cols="7">
        <h1>
          <v-icon style="padding-right: 20px;">fas fa-pencil-alt</v-icon
          >หน้ากรอก Form ข้อมูลลงในระบบ
        </h1>
        <br />
...
<script>
import Entry from "@/pages/dashboard/input/Entry";
import Exit from "@/pages/dashboard/input/Exit";
export default {
  name: "Input",
  components: {
    Entry,
  ...
  data: () => ({
    ...
    Page: "Entry",
    items: [
      { tab: "รับรถเข้า", content: "Entry" },
      { tab: "จ่ายรถออก", content: "Exit" }
    ]
  }),
  methods: {
